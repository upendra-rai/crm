            ...
            <section class="section_card" id="table_section">
                 ...
                 <header class="panel-heading" style="padding:0px 15px;">
                      ...
                      <div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
                          ...
                          <h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
                            ...
                            <a href="<?php echo base_url(); ?>/lead/add"type="btn" class="btn-transparent btn-green" style="position:absolute; right:12px; top:8px;">Add Project</a>
                          </h2>
                      </div>
                </header>
                <div class="panel-body " style="padding-top:0px;">
                  ...
                  <tbody>
                      ...
                      <?php  $i = 1; if(isset($lead_details)) {foreach($lead_details as $row) {?>
                          <tr>
                    ...
                    <td><?php echo $row->lastcontact; ?></td>
                    <td><?php echo $row->dateassigned; ?></td>
                    <td><?php echo $row->staff_id; ?></td>
                    <td><?php echo $row->dateconverted; ?></td>
                    <td><?php echo $row->lost; ?></td>
                    <td><?php echo $row->junk; ?></td>
                    ...
                    <td>
                    <a 
                     href="<?php echo base_url(); ?>/lead/edit/<?php echo $row->id; ?>"> <button type="button"   style=" width:100%;"><i class="fa fa-pencil"></i>
                   </a>
                      </td>
...
// delete functionality
    ...
    $(document).on('click','button[id=del_bt]',function(){
       ...
       //  alert(del_id);
              $.ajax({
                  url : '<?php echo base_url(); ?>/lead/delete_lead',
                  method: 'POST',
                  data:{vv: del_id},
                  success:function(data){
                    //alert(data);
