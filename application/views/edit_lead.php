                    ...
                    <div class="col-md-6" style="padding:0px;">
											 <div class="col-md-12">
											   <div class="form-group">
												  <div class="col-md-12">
													   <input type="text" class="form-control" name="id" placeholder="Id" value="<?php echo $selected_list[0]->id; ?>" required>
												  </div>
											   </div>
											</div>
											   <div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="type" placeholder="Type" value="<?php echo $selected_list[0]->type; ?>" >
													 </div>
												 </div>
											</div>
											 ...
											 <div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="product_id" placeholder="Product Id" value="<?php echo $selected_list[0]->product_id; ?>" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="name" placeholder=" Name" value="<?php echo $selected_list[0]->name; ?>" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="title" placeholder="Title" value="<?php echo $selected_list[0]->title; ?>" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="company" placeholder="Company Id" value="<?php echo $selected_list[0]->company; ?>" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="description" placeholder="Description" value="<?php echo $selected_list[0]->description; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="country_id" placeholder="Country Id" value="<?php echo $selected_list[0]->country_id; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="zip" placeholder="Zip" value="<?php echo $selected_list[0]->zip; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="city" placeholder="City" value="<?php echo $selected_list[0]->city; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="state" placeholder="State" value="<?php echo $selected_list[0]->state; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="email" placeholder="Email" value="<?php echo $selected_list[0]->email; ?>" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="address" placeholder="Address" value="<?php echo $selected_list[0]->address; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="website" placeholder="Website" value="<?php echo $selected_list[0]->website; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="phone" placeholder="phone No" value="<?php echo $selected_list[0]->phone; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="assigned_id" placeholder="Assigned Id" value="<?php echo $selected_list[0]->assigned_id; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="date" class="form-control" name="created" placeholder="Created" value="<?php echo $selected_list[0]->created; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="status" placeholder="Status" value="<?php echo $selected_list[0]->status; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="source" placeholder="Source" value="<?php echo $selected_list[0]->source; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="datetime-local" class="form-control" name="lastcontact" placeholder="Last Contact" value="<?php echo $selected_list[0]->lastcontact; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="date" class="form-control" name="dateassigned" placeholder="Date Assigned" value="<?php echo $selected_list[0]->dateassigned; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="staff_id" placeholder="Staff Id" value="<?php echo $selected_list[0]->staff_id; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="datetime-local" class="form-control" name="dateconverted" placeholder="Date Converted" value="<?php echo $selected_list[0]->dateconverted; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="lost" placeholder="Lost" value="<?php echo $selected_list[0]->lost; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="junk" placeholder="Junk" value="<?php echo $selected_list[0]->junk; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="public" placeholder="Public" value="<?php echo $selected_list[0]->public; ?>" >
													 </div>
												 </div>
											</div>
										</div>
