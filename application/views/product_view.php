            ...
            <section class="section_card" id="table_section">
                 ...
                 <header class="panel-heading" style="padding:0px 15px;">
                      ...
                      <div class="heading_box" style=" border-bottom: none; padding: 6px 2px; height:36px; background-color:#27293d;">
                          ...
                          <h2 class="panel-title" style="color:#dbd6d6; font-size:16px; line-height:10px; text-transform:uppercase;">
                            ...
                            <a href="<?php echo base_url(); ?>/products/add"type="btn" class="btn-transparent btn-green" style="position:absolute; right:12px; top:8px;">Add Project</a>
                          </h2>
                      </div>
                </header>
                <div class="panel-body " style="padding-top:0px;">
                  ...
                  <tbody>
                      ...
                      <?php  $i = 1; if(isset($product_details)) {foreach($product_details as $products) {?>
                          <tr>
                            
                              <td><?php echo $i++; ?></td>
                    <td><?php echo $products->productname; ?></td>
                    <td><?php echo $products->description; ?></td>
                    <td><?php echo $products->productimage; ?></td>
                    <td><?php echo $products->purchase_price; ?></td>
                    <td><?php echo $products->sale_price; ?></td>
                    <td><?php echo $products->stock; ?></td>
                    <td><?php echo $products->vat; ?></td>
                    <td><?php echo $products->status_id; ?></td>
                    ...
                    <td>
                    <a 
                     href="<?php echo base_url(); ?>/products/edit_product/<?php echo $products->id; ?>"> <button type="button"   style=" width:100%;"><i class="fa fa-pencil"></i>
                   </a>
                      </td>
                      

                              <td style="text-align:center;"><button type="button" class="btn btn-primary" id="confirm_del_action" data-confirm_del_id="<?php echo $products->id; ?>" style="color:#ff4747; "><i class="fa  fa-times-circle"></i></button>
                              </td>
                          </tr>
                    <?php } } ?>
                  </tbody>
