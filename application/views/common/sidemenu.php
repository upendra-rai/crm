    ...
    <div class="nano-content">
      <nav id="menu" class="nav-main" role="navigation">
        <ul class="nav nav-main">
          ...
          <li class="<?php if(isset($active_menu)){ if($active_menu == 'dashboard'){ echo 'nav-active'; } } ?>" name="dashboard">
           ...
           <li class="nav-parent <?php if(isset($active_menu)){ if($active_menu == 'parameter'){ echo 'nav-expanded nav-active'; } } ?>" name="paremeter">
            ...
            <ul class="nav nav-children">
              <li class="">
                <a href="<?php echo base_url(); ?>products/product_details">
                   Product
                </a>
              </li>
              ...
              <li class="">
                <a href="<?php echo base_url(); ?>source/source_details">
                   Source
                </a>
              </li>
             
              <li class="">
                <a href="<?php echo base_url(); ?>status/status_details">
                   Lead Status
                </a>
              </li>
            </ul>
          ...
          <li class="">
            <a href="<?php echo base_url(); ?>customers/customers_detail">
              <i class="fa fa-home" aria-hidden="true"></i>
              <span>Customers</span>
            </a>
          </li>
          <li class="">
            <a href="<?php echo base_url(); ?>lead/lead_details">
              <i class="fa fa-home" aria-hidden="true"></i>
              <span>Leads</span>
            </a>
          </li>
