				...
				<section role="main" class="content-body" >
                    ...
                    <div class="col-md-6" style="padding:0px;">
											 ...
											 <div class="col-md-12">
		 										<div class="form-group">
		 											<div class="col-md-12">
		 												<input type="text" class="form-control" name="name" placeholder=" Name" value="<?php echo $selected_list[0]->name; ?>" required>
		 											</div>
		 										</div>
		 								 </div>
											 <div class="col-md-12">
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="status_id" placeholder="Status Id" value="<?php echo $selected_list[0]->status_id; ?>" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="customer_id" placeholder="Customer Id" value="<?php echo $selected_list[0]->customer_id; ?>" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="invoice_id" placeholder="Invoice Id" value="<?php echo $selected_list[0]->invoice_id; ?>" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="date" class="form-control" name="start_date" placeholder="Start Date" value="<?php echo $selected_list[0]->start_date; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="date" class="form-control" name="deadline" placeholder="Deadline" value="<?php echo $selected_list[0]->deadline; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="date" class="form-control" name="created" placeholder="Created" value="<?php echo $selected_list[0]->start_date; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="datetime-local" class="form-control" name="finished" placeholder="Finished" value="<?php echo $selected_list[0]->finished; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="pinned" placeholder="Pinned" value="<?php echo $selected_list[0]->pinned; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
