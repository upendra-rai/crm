				...
				<section role="main" class="content-body" >
					...
					<section class="section_card">
						 ...
						 <div class="panel-body" style="padding-left:0px; padding-right:0px;  background-color:#27293d; padding-top:15px; padding-bottom:0px;">
										<form class="form-horizontal form-bordered" action="<?php echo base_url(); ?>projects/add" method="post">
                    <div class="col-md-6" style="padding:0px;">
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="status_id" placeholder="Status Id" value="" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="invoice_id" placeholder="Invoice Id" value="" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="datetime-local" class="form-control" name="finished" placeholder="Finished" value="" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="pinned" placeholder="Pinned" value="" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
