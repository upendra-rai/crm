				...
				<section role="main" class="content-body" >
                    ...
                    <div class="col-md-6" style="padding:0px;">
											 ...
											 <div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="date" class="form-control" name="created" placeholder="Created Id" value="" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="namesurname" placeholder="namesurname" value="" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="taxoffice" placeholder="Tax Office " value="" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="taxnumber" placeholder="Tax Number" value="" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="executive" placeholder="Executive" value="" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="web" placeholder="Website" value="" >
													 </div>
												 </div>
											</div>
										</div>
