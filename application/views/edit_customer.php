				...
				<section role="main" class="content-body" >
                    ...
                    <div class="col-md-6" style="padding:0px;">
											 ...
											 <div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="date" class="form-control" name="created" placeholder="Created Id" value="<?php echo $selected_list[0]->created; ?>" >
													 </div>
												 </div>
											</div>
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="company" placeholder="Company" value="<?php echo $selected_list[0]->company; ?>" >
													 </div>
												 </div>
											</div>	
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="namesurname" placeholder="namesurname" value="<?php echo $selected_list[0]->namesurname; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="taxoffice" placeholder="Tax Office " value="<?php echo $selected_list[0]->taxoffice; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="taxnumber" placeholder="Tax Number" value="<?php echo $selected_list[0]->taxnumber; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="executive" placeholder="Executive" value="<?php echo $selected_list[0]->executive; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="zipcode" placeholder="Zip Code" value="<?php echo $selected_list[0]->zipcode; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="city" placeholder="City" value="<?php echo $selected_list[0]->city; ?><?php echo $selected_list[0]->city; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="town" placeholder="Town" value="<?php echo $selected_list[0]->town; ?>" >
													 </div>
												 </div>
											</div>
											<div class="col-md-12">
											...
											<div class="col-md-12">
												 <div class="form-group">
													 <div class="col-md-12">
														 <input type="text" class="form-control" name="web" placeholder="Website" value="<?php echo $selected_list[0]->web; ?>" >
													 </div>
												 </div>
											</div>
										</div>
